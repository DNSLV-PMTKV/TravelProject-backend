...
class ForgotPasswordAPITests(TestCase):
    ...
    def test_user_sends_request_more_than_once(self):
        ...
        count = ForgotPassword.objects.filter(user__email=data["email"]).count()
    ...
    def test_update_user_password(self):
        ...
        update_data = {"reset_token": token, "password": "aloda", "password2": "aloda"}

        res = self.client.put(self.url, update_data, content_type="application/json")
    ...
    def test_update_user_password_missmatch_passwords(self):
        ...
        update_data = {"reset_token": token, "password": "aloda1", "password2": "aloda"}
    ...
    def test_send_patch_request(self):
        ...
        res = self.client.patch(self.url, data, content_type="application/json")
